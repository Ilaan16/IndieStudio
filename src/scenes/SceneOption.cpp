...
namespace indie {
    SceneOption::SceneOption()
    {
        ...
        std::unique_ptr<MouseEvent> slider = std::make_unique<Slider>();
        ...
        Entities.createLogo(_entities, "./assets/options/slider.png", "Play", {660.0f, 400.0f, 0.0f}, {29.0f, 80.0f, 0.0f}, {595.0f, 0.0f, 0.0f});
        this->addEventToLastEntity(MouseButton::MOUSE_BUTTON_LEFT, slider);
        Entities.createButton(_entities, "FULLSCREEN", {660.0f, 520.0f, 0.0f}, {600.0f, 80.0f, 0.0f}, {804.0f, 0.0f, 0.0f}, {790.0f, 540.0f, 0.0f});
